...
/home/rooot/.openclaw/workspace-main/skills/*/
```
...
# main bot skill
find /home/rooot/.openclaw/workspace-main/skills/ -type f \( -name "*.md" -o -name "*.py" -o -name "*.sh" -o -name "*.js" \) 2>/dev/null
```
...
将报告保存到：
```
/home/rooot/.openclaw/workspace-main/memory/security-audit-YYYY-MM-DD.md
```
