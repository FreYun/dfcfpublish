...
3. Read `TOOLS.md` — tool usage rules: zhipu MCP, browser sites, Tushare, research priorities
4. Read `memory/YYYY-MM-DD.md` (today + yesterday) for recent context
5. **If in MAIN SESSION** (direct chat with your human): Also read `MEMORY.md`
6. **Before starting any task**: Search QMD memory for relevant prior context — `qmd search "{topic/关键词}"` — build on what exists, don't start from scratch.
