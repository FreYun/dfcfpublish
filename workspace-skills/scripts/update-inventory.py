...
"""
技能部目录刷新脚本
更新 workspace-skills/memory/ 下的所有目录文件
"""
...
MEMORY = f"{BASE}/workspace-skills/memory"
...
# workspace-main 独有 skill
main_skills = f"{BASE}/workspace-main/skills"
...
configs = {
    **{f"bot{i}": f"{BASE}/workspace-bot{i}/config/mcporter.json" for i in range(1, 11)},
    ...
    "mcp_publisher": f"{BASE}/workspace-mcp-publisher/config/mcporter.json",
}
